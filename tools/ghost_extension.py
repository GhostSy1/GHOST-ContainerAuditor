...
VERSION = "3.0-PRO"
PROFILE = "Container image and Dockerfile hardening auditor"
RULES = [('CTR-ROOT', 'USER\\s+root|runAsUser:\\s*0'), ('CTR-PRIV', 'privileged:\\s*true|docker\\.sock|hostNetwork'), ('CTR-TAG', 'FROM\\s+[^\\n:]+\\s*$|:latest')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-ContainerAuditor v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
